...
<!doctype html>
        <html>
           ...
           <script type="text/javascript">
                   function  asd() {
                       ...
                       function ddd(data) {
                           ...
                           if (a=="1"){
                               ...
                               $(a).each(function () {
                                   $("."+data.n).prepend("<p>"+"回复内容："+this.huifuneirong+"<span>"+"回复时间："+this.time+"</span>"+"<span>"+"回复人："+this.huifuze+"</span>"+"</p><input type='button'" +
                                       " onclick='shanchu(\""+this.huifuze+"\",\""+name+"\",\""+this.huifuid+"\")' value='删除'>");
                               })
                           }
                   ...
                   function shanchu(shan,tzid,hufuid) {
                       if (confirm("是否确定要删除")) {
                           $.getJSON("/scc","tzid="+tzid+"&id="+shan+"&huifuid="+hufuid,hui);
                           function hui(data) {
                               alert(data.name);
                           }
                       }else {
