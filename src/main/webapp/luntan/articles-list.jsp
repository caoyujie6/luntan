                ...
                <div class="search-area-wrapper">
                        <div class="search-area container">
                                ...
                                <form id="search-form" class="search-form clearfix" method="get" action="#" autocomplete="off">
                                        <input class="search-term required" type="text" id="s" name="s" placeholder="请输入关键词" title="* 请输入搜索内容!" style="height: 47.67px"  />
                                            ...
                                            <article class="format-standard type-post hentry clearfix">
                                                ...
                                                <header class="clearfix">
                                                    ...
                                                    <div class="post-meta clearfix">
                                                        ...
                                                        <span class="category"><a href="#" title="View all posts in Server &amp; Database"><%=loginSeriver.select(tiezis.get(i).getBKid()).getName()%></a></span>
                                                        <span class="comments"><a href="#" title="Comment on Integrating WordPress with Your Website"><%=loginSeriver.selectHfTznum(tiezis.get(i).getTieziid())%> 评论</a></span>
