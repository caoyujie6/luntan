...
public class BadWordUtil2 {
    public static String filePath = "D:\\安装包集合地\\新建文件夹\\网站敏感词库\\百度敏感词\\百度过滤词.txt";//敏感词库文件路径
    ...
    //静态代码块
    static{
        BadWordUtil2.words = readTxtByLine(filePath);    //将本地得敏感词库读入集合内
        ...
        while(iterator.hasNext()){
            ...
            for(int i = 0 ; i < key.length() ; i++){
                ...
                if(wordMap != null){        //如果存在该key，直接赋值
                    ...
                    newWorMap = new HashMap<String,String>();  //new一个新的Map
    ...
    public static void main(String[] args) {
        ...
        String string = "你妈的，我操,漂亮，日你妈，操，狗比";
        ...
        String aaaa=BadWordUtil2.replaceBadWord(string,1,"*");
