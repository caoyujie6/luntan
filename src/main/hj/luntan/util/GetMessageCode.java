...
public class GetMessageCode {
    ...
    private static final String ACCOUNT_SID = "d3a7a5d90ded44b393ce34d34edec656";
    private static final String AUTH_TOKEN = "204f3e426bf74c829cb3b27105f9dd97";
    ...
    public static String getCode(String phone) {
        ...
        int i=1;
        String tamp = "【恒迹论坛】您的验证码为"+rod+"，请于"+i+"分钟内正确输入，如非本人操作，请忽略此短信。";
    ...
    public static void main(String[] args) {
        String i=GetMessageCode.getCode("15503641433");
